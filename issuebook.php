            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="post" action="bookissuecode.php">
...
function checkdata() {
	 if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","check.php?bid="+document.getElementById("bookidid").value+"&sid="+document.getElementById("studentidid").value,true);
        xmlhttp.send();
...
function checkbook() {
	 if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","checkbookdata.php?bid="+document.getElementById("bookidid").value,true);
        xmlhttp.send();
