          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Manage Admin <small></small></h2>
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="Employee.php?edit=<?php echo $row['AdminId']; ?>">Edit</a>
			</td>
			<td>
				<a class="btn btn-primary" href="EmployeeCode.php?del=<?php echo $row['AdminId']; ?>">Delete</a>
			</td>
